            ...
            <div class="flex flex-col md:px-12 w-full ">
                <form id="order-form" action="{{ route('order.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class=" p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 ">
                        <div class="flex flex-wrap ">
                            <div class=" px-1 mb-3 w-full md:w-1/2 lg:w-1/3 ">
                                ...
                                <input type="text" name="paper_topic"
                                    class="w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-cyan-500 focus:ring-2 focus:ring-blue-200 text-base h-12 outline-none mt-2 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out @error('paper_topic') border-red-500 @enderror" value="{{ old('paper_topic', '') }}"
                            ...
                            <div class="px-1 mb-3 w-full md:w-1/2 lg:w-1/3">
                                ...
                                <select name="paper_type"
                                    class="w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-cyan-500 focus:ring-2 focus:ring-blue-200 text-base h-12 outline-none mt-2 py-3 px-3 leading-8 transition-colors duration-200 ease-in-out @error('paper_type') border-red-500 @enderror">
                            ...
                            <div class="px-1 mb-3 w-full md:w-1/2 lg:w-1/3">
                                ...
                                <select name="deadline" id="deadline"
                                    class="get-fare w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-cyan-500 focus:ring-2 focus:ring-blue-200 text-base h-12 outline-none mt-2 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out @error('deadline') border-red-500 @enderror">
                            ...
                            <div class="px-1 mb-3 w-full md:w-1/2 lg:w-1/3">
                                ...
                                <label>Style:</label>
                                <select name="style"
                                    class="w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-cyan-500 focus:ring-2 focus:ring-blue-200 text-base h-12 outline-none mt-2 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out @error('style')border-red-500 @enderror">
                                    <option hidden="" value="0" disabled="" selected="">Styles</option>
                                    @foreach ($reference_styles as $style)
                                        <option {{old('reference_styles') == $style->id ? 'selected' : '' }} value="{{ $style->id }}">{{ $style->name }}</option>
                                    @endforeach
                                </select>
                                @error('style')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                            ...
                            <div class="px-1 mb-3 w-full md:w-1/2 lg:w-1/3">
                                ...
                                <select name="language"
                                    class="w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-cyan-500 focus:ring-2 focus:ring-blue-200 text-base h-12 outline-none mt-2 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out @error('reference')border-red-500 @enderror">
                            ...
                            <div class="px-1 mb-3 w-full md:w-1/2 lg:w-1/3">
                                ...
                                <select name="academic_level" id="academic_level"
                                    class="get-fare w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-cyan-500 focus:ring-2 focus:ring-blue-200 text-base h-12 outline-none mt-2 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out @error('academic_level')border-red-500 @enderror">
                            ...
                            <div class="px-1 mb-3 w-full md:w-1/2 lg:w-1/3">
                                ...
                                <select name="number_of_pages" id="no_of_pages"
                                    class="get-fare w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-cyan-500 focus:ring-2 focus:ring-blue-200 text-base h-12 outline-none mt-2 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out @error('number_of_pages') border-red-500 @enderror">
                            ...
                            <div class=" px-1 mb-3 w-full lg:w-1/3">
                                ...
                                <select name="subject_area"
                                    class="w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-cyan-500 focus:ring-2 focus:ring-blue-200 text-base h-12 outline-none mt-2 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out @error('subject_area') border-red-500 @enderror">
                                    <option hidden="" value="0" disabled="" selected="">Subjects</option>
                                    @foreach ($subjects as $subject)
                                        <option {{old('subject_area') == $subject->id ? 'selected' : '' }} value="{{ $subject->id }}">{{ $subject->name }}</option>
                                    @endforeach
                                </select>
                                @error('subject_area')
                                    <p class="text-red-600 text-sm">{{ $message }}</p>
                            ...
                            <div class=" w-full lg:w-1/2 my-5">
                                <div class="flex items-center ">
                                    ...
                                    <div class="ml-5 form-check form-check-inline">
                                        <input name="spacing"
                                            class="form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-900 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                            ...
                            <div class="w-full lg:w-1/2 mb-3">
                                <div class="w-full px-1 mb-3">
                                    <p class="text-blue-500 text-base ">Attach File (max file attach : 10 | max file
                                        size : 25Mb)</p>
                                ...
                                <p class="text-blue-500 text-sm">if file is larger then 25Mb then please email us on
                        ...
                        <h2 class="text-blue-700 my-4 font-medium title-font text-4xl text-center">Contact Information</h2>
                        ...
                        <div class="flex flex-wrap ">
                            ...
                            <div class="w-full md:w-1/2 px-1 mb-3">
                                ...
                                <input type="tel" name="Phone" id="phone"
                                    class="w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-cyan-500 focus:ring-2 focus:ring-blue-200 text-base h-12 outline-none py-2 px-3 mt-2 leading-8 transition-colors duration-200 ease-in-out  @error('phone') border-red-500 @enderror"
                                    placeholder="Phone"  value="{{ old('phone') }}" oninput="this.value=this.value.replace(/[^0-9\+]/g,'');" autocomplete="off"
