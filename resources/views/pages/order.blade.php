                        ...
                        <div class="flex flex-wrap ">
                            <div class=" px-1 mb-3 w-full md:w-1/2 lg:w-1/3 ">
                                ...
                                <input type="text" name="paper_topic"
                                    class="w-full text-gray-700 rounded border border-gray-300 bg-white  focus:border-red-500 focus:ring-2 focus:ring-red-200 text-base h-12 outline-none mt-2 py-2 px-3 leading-8 transition-colors duration-200 ease-in-out @error('paper_topic') border-red-500 @enderror placeholder-black" value="{{ old('paper_topic', '') }}"
